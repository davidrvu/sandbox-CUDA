...
// KERNEL
//////////////////////////////////////////////////
__global__ void multKernel(float *d_resultado, float *d_x, float *d_y, float *d_z, int numFilas){
...
void mult_cu(int debug, int coutMode, float *h_resultado, float *h_x, float *h_y, float *h_z, int numFilas){
	...
	//////////////////////////////////////////////////
	multKernel<<<numBlocks, threadsPerBlock>>>(d_resultado, d_x, d_y, d_z, numFilas);

	cudaSyncGetLastError(error, "AL EJECUTAR multKernel");
