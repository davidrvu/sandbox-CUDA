...
Func1::Func1(
	...
	coutDeb(debug, " Constructor de la clase Func1");

	func1Main(debug, coutMode, outputCSV, numFilas, fileOut);

}
	
int Func1::func1Main(int debug, int coutMode, int outputCSV, int numFilas, std::string fileOut){
	coutDeb(debug, "----> Func1::func1Main");
